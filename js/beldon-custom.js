// ------------------------------------------------
// Project Name: Tribe - Coming Soon and Landing Page Template
// Project Description: Tribe - awesome coming soon template to kick-start your project
...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2023, 10, 21), format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
